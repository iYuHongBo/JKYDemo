...
@interface JKYMagicMoveAnimation ()

@property (nonatomic, assign) JKYMagicMoveAnimationType type;

@end

@implementation JKYMagicMoveAnimation
...
{
    if (_type == JKYMagicMoveAnimationTypePush) {
...
{
    JKYMagicMoveFromViewController *fromVC = (JKYMagicMoveFromViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    JKYMagicMoveToViewController *toVC = (JKYMagicMoveToViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    //拿到当前点击的cell的imageView
    JKYMagicMoveCell *cell = (JKYMagicMoveCell *)[fromVC.collectionView cellForItemAtIndexPath:fromVC.currentIndexPath];
...
{
    JKYMagicMoveToViewController *fromVC = (JKYMagicMoveToViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    JKYMagicMoveFromViewController *toVC = (JKYMagicMoveFromViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    JKYMagicMoveCell *cell = (JKYMagicMoveCell *)[toVC.collectionView cellForItemAtIndexPath:toVC.currentIndexPath];
    UIView *containerView = [transitionContext containerView];
