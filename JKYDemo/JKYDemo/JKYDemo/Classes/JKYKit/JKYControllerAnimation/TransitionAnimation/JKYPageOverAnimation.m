...
@interface JKYPageOverAnimation ()

@property (nonatomic, assign) JKYPageOverAnimationType type;

@end

@implementation JKYPageOverAnimation
...
{
    if (self.type == JKYPageOverAnimationPush) {
