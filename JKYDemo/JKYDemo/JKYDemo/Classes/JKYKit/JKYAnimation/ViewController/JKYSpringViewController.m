//
//  JKYSpringViewController.m
//  JKYDemo
//
//  Created by Jacky Yu on 2017/5/17.
//  Copyright © 2017年 Jacky Yu. All rights reserved.
//

#import "JKYSpringViewController.h"

@interface JKYSpringViewController ()
//View
...
@implementation JKYSpringViewController
...
- (void)onTapPositionButton:(UIButton *)button
{
    ...
    animation.toValue = [NSValue valueWithCGPoint:CGPointMake(self.imageView.center.x, self.view.frame.size.height - 150)];
...
- (void)onTapTransformButton:(UIButton *)button
{
    ...
    CASpringAnimation *rotationAnimation = [CASpringAnimation animationWithKeyPath:@"transform.rotation.z"];
    rotationAnimation.mass = 5;
    rotationAnimation.stiffness = 100;
    ...
    CASpringAnimation *translationAnimation = [CASpringAnimation animationWithKeyPath:@"transform.translation"];
    translationAnimation.mass = 5;
    translationAnimation.stiffness = 100;
    translationAnimation.damping = 10;
    translationAnimation.initialVelocity = 5;
...
- (void)onTapBoundsButtonButton:(UIButton*)button
{
    ...
    animation.duration = 2;
    animation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseInEaseOut];
    animation.toValue = [NSValue valueWithCGRect:CGRectMake(self.imageView.center.x, self.imageView.center.y, 150, 150)];
...
- (void)onTapShadowColorButton:(UIButton*)button
{
    ...
    CASpringAnimation *animation = [CASpringAnimation animationWithKeyPath:@"shadowColor"];
    animation.mass = 5;
    animation.stiffness = 100;
    animation.damping = 10;
    animation.initialVelocity = 5;
...
- (void)onTapShadowOffsetButton:(UIButton*)button
{
    ...
    CASpringAnimation *animation = [CASpringAnimation animationWithKeyPath:@"shadowOffset"];
    animation.mass = 5;
    animation.stiffness = 100;
    animation.damping = 10;
    animation.initialVelocity = 5;
...
- (void)onTapShadowOpacityButton:(UIButton*)button
{
    ...
    CASpringAnimation *animation = [CASpringAnimation animationWithKeyPath:@"shadowOpacity"];
    animation.mass = 5;
    animation.stiffness = 100;
    animation.damping = 10;
    animation.initialVelocity = 5;
...
- (void)onTapShadowRadiusButton:(UIButton*)button
{
    ...
    CASpringAnimation *animation = [CASpringAnimation animationWithKeyPath:@"shadowRadius"];
    animation.mass = 5;
    animation.stiffness = 100;
    animation.damping = 10;
    animation.initialVelocity = 5;
